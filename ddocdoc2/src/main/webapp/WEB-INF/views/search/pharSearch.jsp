...
function displayInfowindow(marker, title, posit) {
	var cus_name = '${customer.cus_name}';
	 var content = '<div style="padding:5px;">'+title+'<br><a href="/customer/pharResForm?cus_name='+cus_name+'&phar_name='+title+'" style="color:blue" target="_blank">접수하기</a> <a href="https://map.kakao.com/link/to/'+title+','+posit.getLat()+','+posit.getLng()+'" style="color:blue" target="_blank">길찾기</a></div>';
