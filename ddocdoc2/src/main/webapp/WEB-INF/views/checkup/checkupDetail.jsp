...
<!-- end menu module -->
	...
	<form style="margin-bottom: 10px;" id="updateForm">
	 <div style="width: 300px">
		...
		<input type="hidden" name="cup_content" value="${ccvo.cup_content}">
		<div style="display: flex; justify-content: center; height: 33px; width: 350px;" >
			<label style="margin-left: 4px">검진일</label>  &nbsp&nbsp<input type="text" name="cup_date" id="datepicker" value="${civo.cup_date }" style="width: 230px;" class="form-control">
		</div>
		<script type="text/javascript">
		...
		<label style="margin-left: 7px">메모</label> <input type="text" name="che_memo" value="${ccvo.che_memo }" class="form-control" style="margin-left: 2px"><br>
