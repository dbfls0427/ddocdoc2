	...
	<tr>
		...
		<c:forEach var="pharmacyvo" items="${list}">
			<tr>
				...
				<td><a href="/pharmacy/pharmacyDetail?phar_num=${pharmacyvo.phar_num }">${pharmacyvo.phar_name }</a></td>
		</c:forEach>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="mailto:amydreamsu@gmail.com">LEE MINHYE 2019</a></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
