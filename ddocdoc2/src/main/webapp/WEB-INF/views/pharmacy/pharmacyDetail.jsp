...
<table border="1">
	...
	<tr>
		...
		<tr>
			<td scope="row"><c:out value="${pharmacyvo.phar_num }"/></td>
			<td><c:out value="${pharmacyvo.phar_name }"/></td>
			<td><c:out value="${pharmacyvo.phar_tel }"/></td>
			<td><c:out value="${pharmacyvo.phar_addr }"/></td>
			<td><c:out value="${pharmacyvo.phar_time }"/></td>
