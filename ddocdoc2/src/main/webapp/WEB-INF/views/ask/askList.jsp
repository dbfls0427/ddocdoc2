      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row" style="display: flex;justify-content: space-between;padding-bottom: 20px;">
          	<h3>자주묻는질문</h3>
        	<a href="/board/askInsert" class="btn btn-secondary" role="button">자주질문 입력</a><br>
          </div>
          ...
          <div class="row">
	          ...
	          <div class="card shadow mb-4" style="width:60%;">
	            <div class="card-header py-3">
	              <h6 class="m-0 font-weight-bold text-primary">자주묻는질문 리스트</h6>
	            </div>
	            <div class="card-body">
	              	...
	              	<table class="table table-hover">
					   <tr>
						...
						<c:forEach var="askvo" items="${list}">
							<tr>
								<td>${askvo.ask_num }</td>
								<td><a href='/board/askDetail?ask_num=${askvo.ask_num }'>${askvo.ask_title }</a></td>
